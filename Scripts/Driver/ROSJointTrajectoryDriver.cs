...
namespace Robotics.Driver
{
...
#endif
    {
        ...
        void Start()
        {
            ...
            Action<JointTrajectoryControllerStateMessage> onMessageAction = onRosMessage;
            connection.Subscribe<JointTrajectoryControllerStateMessage>(topic, onMessageAction);
        }
        ...
        private void onRosMessage(JointTrajectoryControllerStateMessage msg)
        {
            if (!isEnabled)
            {
                return;
